...
file_to_load = os.path.join("Desktop", "Analysis_Projects", "election_analysis", "Resources", "election_results.csv")

# Add a variable to save the file to a path.
file_to_save = os.path.join("Desktop", "Analysis_Projects", "election_analysis", "analysis", "election_results.txt") 
