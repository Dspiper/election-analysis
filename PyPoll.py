...
# Initialize total votes variable to zero
total_votes = 0 

# Declare new list for candidate options 
candidate_options = []

# Delcare empty dictionary 
candidate_votes = {}

# Delacre variables to hold winning candiate and winning counts tracker
winning_candidate = ""
winning_count = 0
...
with open(file_to_save, "w") as txt_file:
   ...
   for candidate_name in candidate_votes:
      ...
      # Print each candiate, their voter count, and percentag to the terminal.   
      candidate_results = (f"{candidate_name}: {vote_percentage:.1f}% ({votes:,})\n")
      print(candidate_results)

      # Save the candiate results to out text file. 
